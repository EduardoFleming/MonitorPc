...
def consultar_gemini(api_key, cpu, gpu, ram, board, disks, uso_principal, uso_detalhe):
    ...
    [TABELA]
    | Tipo de Peça | Modelo | Pesquisar |
    | :--- | :--- | :--- |
    | Processador | ... (Manter atual ou Upgrade) | [Ver Preço](https://www.google.com/search?tbm=shop&q=...) |
    | Placa de Vídeo | ... (Manter atual ou Upgrade) | [Ver Preço](https://www.google.com/search?tbm=shop&q=...) |
    | Memória RAM | ... (Manter atual ou Upgrade) | [Ver Preço](https://www.google.com/search?tbm=shop&q=...) |
    | Placa-Mãe | ... (Manter atual ou Upgrade) | [Ver Preço](https://www.google.com/search?tbm=shop&q=...) |
    """
